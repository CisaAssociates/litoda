   ...
   if (session_status() === PHP_SESSION_NONE) {
                    ...
                    <?php if ($result->num_rows > 0): ?>
                        <?php while($row = $result->fetch_assoc()): ?>
                            <tr>
                               ...
                               <td>
    <?php 
    // Display "None" if contact number is empty or null
    echo !empty($row['contact_no']) && trim($row['contact_no']) !== '' 
    ...
    <div class="colInputSection">
        ...
        <input type="text" name="contact" id="contactnumber" placeholder="09XXXXXXXXX (Optional)" maxlength="11" pattern="[0-9]{11}" title="Please enter exactly 11 digits">
        <small style="color:#6b7280; font-size:12px; display:block; margin-top:4px;">Must be exactly 11 digits (Optional - Leave blank if none)</small>
    </div>
</div>
    ...
    <div class="colInputSection">
        ...
        <input type="text" name="contact" id="edit_contact" placeholder="09XXXXXXXXX (Optional)" maxlength="11" pattern="[0-9]{11}" title="Please enter exactly 11 digits">
        <small style="color:#6b7280; font-size:12px; display:block; margin-top:4px;">Must be exactly 11 digits (Optional - Leave blank if none)</small>
    </div>
</div>
